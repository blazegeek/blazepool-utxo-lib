 ...
 * @returns {string} the name of the network. Returns undefined if network is not a value of `networks`
 */
 ...
 */
const isValidNetwork = typeforce.oneOf(isBitcoin, isBitcoinCash, isBitcoinGold, isBitcoinSV, isDash, isGeek, isLitecoin, isZcash);
